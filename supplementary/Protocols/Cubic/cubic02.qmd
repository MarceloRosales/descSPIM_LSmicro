...
Mouse [whole-Body Clearing](https://www.tcichemicals.com/assets/brochure-pdfs/Brochure_LL060_E.pdf){target="_blank"} (without decalcification process)
...
## Decalcification + Cubic-HV 

### Process outline:

![](images/Bone_clearing01.png)

![](images/Bone_clearing02.png)

Process details:

(see cubic_hv section)
