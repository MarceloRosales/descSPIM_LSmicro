...
![\@hong2019](images/hong2019_img_001.png){alt="@hong2019," group="gallery02"}
...
Volumetric (3D) Distribution of vascular network in relation to Progenitor cells (Osteo, cementoblasts) in PDL and calvaria.
...
Calcium dynamics in bone repair (in calvaria defect, implant and tooth movement of PDL) like in sparks et al.
